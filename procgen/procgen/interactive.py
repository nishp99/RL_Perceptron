...
def main():
    ...
    #CHANGED
    parser.add_argument(
        "--agent-health", type=int, help="number of hits the agent can take in bossfight"
    )

    #CHANGED
    parser.add_argument(
        "--t-max", type=int, help="maximum time of episode"
    )
    ...
    kwargs = {
        ...
        "agent_health": args.agent_health, #CHANGED
        "tmax": args.tmax, #CHANGED
    }
